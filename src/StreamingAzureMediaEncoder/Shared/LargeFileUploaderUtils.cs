...
namespace LargeFileUploader
{
    ...
    public static class LargeFileUploaderUtils
    {
        ...
        public static Task<string> UploadAsync(string inputFile, CloudBlobContainer blobContainer, EventHandler<int> reportProgress, uint uploadParallelism = DEFAULT_PARALLELISM)
        {
            return (new FileInfo(inputFile)).UploadAsync(blobContainer, reportProgress, uploadParallelism);
        }

        public static Task<string> UploadAsync(this FileInfo file, CloudBlobContainer blobContainer, EventHandler<int> reportProgress, uint uploadParallelism = DEFAULT_PARALLELISM)
        {
            return UploadAsync(
        ...
        public static Task<string> UploadAsync(this byte[] data, CloudBlobContainer blobContainer, string blobName, EventHandler<int> reportProgress, uint uploadParallelism = DEFAULT_PARALLELISM)
        {
            return UploadAsync(
        ...
        public static async Task<string> UploadAsync(Func<long, long, Task<byte[]>> fetchLocalData, long blobLenth, CloudBlobContainer blobContainer, string blobName, EventHandler<int> reportProgress, uint uploadParallelism = DEFAULT_PARALLELISM)
        {
